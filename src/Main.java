...
public class Main {
    ...
    System.out.println("Geneder:" +getGenderFromCnp(cnp));
    System.out.println("Birth date:"+getBirtDateFromCnp(cnp));
    System.out.println ("Age:" + calculateAge(parseDateToInt(getCurrentDate()),
        parseDateToInt(getBirtDateFromCnp(cnp))));
    ...
    public  static int calculateAge(int[]currentDate ,int[]birthDate){
        int age  = currentDate[1] - birthDate[0];
    ...
    public static  String getBirtDateFromCnp(String cnp){
